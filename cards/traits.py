...
class Trait:
    ...
    def __init__(self, name, effects, remove_effects, face_value, color, expansion,
...
traits = [Trait(name='Talons', effects=[], remove_effects=[], face_value=2, color='Purple', expansion='Dinolings'),
          ...
          Trait(name='Fine Motor Skills', effects=[], remove_effects=[], face_value=2, color='Purple', expansion='Base'),
...
"""traits = [Trait(name='Teeth', effects=[{'name': 'modify_gene_pool', 'params': {'affected_players': 'self', 'value': 1}}],
          remove_effects=[{'name': 'modify_gene_pool', 'params': {'affected_players': 'self', 'value': -1}}],
          face_value=1, color='Purple', expansion='Base') for _ in range(50)]

traits = [Trait(name='Saliva', effects=[{'name': 'modify_gene_pool', 'params': {'affected_players': 'self', 'value': 1}}],
          remove_effects=[{'name': 'modify_gene_pool', 'params': {'affected_players': 'self', 'value': -1}}],
          face_value=1, color='Blue', expansion='Base') for _ in range(50)]"""
